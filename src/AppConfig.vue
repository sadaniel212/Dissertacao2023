        ...
        <div class="layout-config-content">
            ...
            <div class="layout-config-section options">
                ...
                <div class="p-formgroup-inline p-grid p-nogutter">
                    <div class="p-field-radiobutton p-md-6">
                        <RadioButton id="dark" name="lightMenu" :value="false" v-model="d_lightMenu"
                                     @change="changeMenuColor($event, false)"/>
                        <label for="dark">Dark</label>
                    </div>
                    <div class="p-field-radiobutton p-md-6">
                        <RadioButton id="light" name="lightMenu" :value="true" v-model="d_lightMenu"
            ...
            <div class="layout-config-section options">
                ...
                <div class="p-formgroup-inline p-grid p-nogutter">
                    <div class="p-field-radiobutton p-md-6">
                        <RadioButton id="ltr" name="isRTL" :value="false" v-model="d_isRTL"
                                     @change="changeOrientation($event, false)"/>
                        <label for="ltr">LTR</label>
                    </div>
                    <div class="p-field-radiobutton p-md-6">
                        <RadioButton id="rtl" name="isRTL" :value="true" v-model="d_isRTL"
                                     @change="changeOrientation($event, true)"/>
            ...
            <div class="layout-config-section colors">
                ...
                <div class="layout-themes topbar-colors">
                    <div v-for="t of topbarColors" :key="t.name">
                        <a href="#" class="layout-config-option-color" @click="changeTopbarColor($event, t.topbarColor, t.logo)"
