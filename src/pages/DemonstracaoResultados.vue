<template>
<div class="card">
                <BarraMenu :companyName=companyName :id_company=id_company></BarraMenu>
	<div class="p-col-12">
			

      <div class="p-col-12">
		<DataTable :value="primeiraParte" :rowClass="rowClass" :loading="loading2">
                    <Column header="Descrição" field="name" :style="{width:'300px'}"></Column>
                    <Column header="Valor" field="value" :style="{width:'500px'}" ></Column>    
      </DataTable>
      <DataTable :value="segundaParte" :rowClass="rowClass2" :loading="loading2">
                    <Column field="name" :style="{width:'300px'}"></Column>
                    <Column field="value" :style="{width:'500px'}" ></Column>    
      </DataTable>
  ...
  data() {
    return {
      ...
      primeiraParte: [{
        ...
        {
          name: "Custo de matérias-primas(61)	",
          value : 0
        },
        {
          name: "Fornecimentos de serviços(62)	",
          value : 0
        },
        {
      ...
      menuItems: [
					{
						label: 'Balanço', icon: 'pi pi-fw pi-check' , url: 'balanco'
					},
					{
						label: 'Demonstração resultados', icon: 'pi pi-fw pi-refresh' , url: '/demonstracaoResultados'
					},
					{
						label: 'Download PDF', icon: 'pi pi-fw pi-download'
                    },
                    {
						label: 'Outros SAFT', icon: 'pi pi-fw pi-trash'
                    },
                    {
						label: 'Back', icon: 'pi pi-fw pi-trash' , url: '/company'
					}
                ],
      ...
      axios({
        ...
        .then(data => {
         ...
         console.log(data.data.demonstracaoResultados.somaContaCredit71mes12 + " demonstracao resultado")
          ...
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit71mes12 + this.demonstracaoResultados.somaContaCredit72mes12 + this.demonstracaoResultados.somaContaCredit71mes13 + this.demonstracaoResultados.somaContaCredit72mes13) - (this.demonstracaoResultados.somaContaDebit71mes12 + this.demonstracaoResultados.somaContaDebit72mes12 + this.demonstracaoResultados.somaContaDebit71mes13 + this.demonstracaoResultados.somaContaDebit72mes13) )
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit75mes12+ this.demonstracaoResultados.somaContaCredit75mes13) - (this.demonstracaoResultados.somaContaDebit75mes12+ this.demonstracaoResultados.somaContaDebit75mes13))
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit61mes12 + this.demonstracaoResultados.somaContaCredit62mes12 + this.demonstracaoResultados.somaContaCredit61mes13 + this.demonstracaoResultados.somaContaCredit62mes13) - (this.demonstracaoResultados.somaContaDebit61mes12 + this.demonstracaoResultados.somaContaDebit62mes12 + this.demonstracaoResultados.somaContaDebit61mes13 + this.demonstracaoResultados.somaContaDebit62mes13) )
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit63mes12+ this.demonstracaoResultados.somaContaCredit63mes13) - (this.demonstracaoResultados.somaContaDebit63mes12+ this.demonstracaoResultados.somaContaDebit63mes13))
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit78mes12 + this.demonstracaoResultados.somaContaCredit78mes13) - (this.demonstracaoResultados.somaContaDebit78mes12 + this.demonstracaoResultados.somaContaDebit78mes13) )
          this.totalResultadoLiquidoSemImpostos += ((this.demonstracaoResultados.somaContaCredit68mes12 + this.demonstracaoResultados.somaContaCredit68mes13) - (this.demonstracaoResultados.somaContaDebit68mes12 + this.demonstracaoResultados.somaContaDebit68mes13) )

        this.totalResultadoOperacional =  (this.totalResultadoLiquidoSemImpostos + (( this.demonstracaoResultados.somaContaCredit64mes12  + this.demonstracaoResultados.somaContaCredit64mes13) - (this.demonstracaoResultados.somaContaDebit64mes12 + this.demonstracaoResultados.somaContaDebit64mes13) ))  
        
        this.totalAntesImpostos +=  this.totalResultadoOperacional + ((this.demonstracaoResultados.somaContaCredit79mes12  + this.demonstracaoResultados.somaContaCredit79mes13 ) - (this.demonstracaoResultados.somaContaDebit79mes12  + this.demonstracaoResultados.somaContaDebit79mes13 ))
        this.totalAntesImpostos +=  (( this.demonstracaoResultados.somaContaCredit69mes12  + this.demonstracaoResultados.somaContaCredit69mes13) - (this.demonstracaoResultados.somaContaDebit69mes12 + this.demonstracaoResultados.somaContaDebit69mes13) )
        ...
        // Credito Mes 1 ao 12
        this.totalCreditoAntesImpostosMes12 = this.demonstracaoResultados.somaContaCredit71mes12 + this.demonstracaoResultados.somaContaCredit72mes12 +  this.demonstracaoResultados.somaContaCredit75mes12 + this.demonstracaoResultados.somaContaCredit61mes12 + this.demonstracaoResultados.somaContaCredit62mes12 + this.demonstracaoResultados.somaContaCredit63mes12 + this.demonstracaoResultados.somaContaCredit78mes12 + this.demonstracaoResultados.somaContaCredit68mes12
        // Debito Mes 1 ao 12
        this.totalDebitoAntesImpostosMes12 = this.demonstracaoResultados.somaContaDebit71mes12 + this.demonstracaoResultados.somaContaDebit72mes12 +  this.demonstracaoResultados.somaContaDebit75mes12 + this.demonstracaoResultados.somaContaDebit61mes12 + this.demonstracaoResultados.somaContaDebit62mes12 + this.demonstracaoResultados.somaContaDebit63mes12 + this.demonstracaoResultados.somaContaDebit78mes12 + this.demonstracaoResultados.somaContaDebit68mes12
        // Total mes 1 ao 12
        this.totalAntesImpostosMes12 = this.totalCreditoAntesImpostosMes12 - this.totalDebitoAntesImpostosMes12

        // Credito mes 13
        this.totalCreditoAntesImpostosMes13 = this.demonstracaoResultados.somaContaCredit71mes13 + this.demonstracaoResultados.somaContaCredit72mes13 +  this.demonstracaoResultados.somaContaCredit75mes13 + this.demonstracaoResultados.somaContaCredit61mes13 + this.demonstracaoResultados.somaContaCredit62mes13 + this.demonstracaoResultados.somaContaCredit63mes13 + this.demonstracaoResultados.somaContaCredit78mes13 + this.demonstracaoResultados.somaContaCredit68mes13
        // Debito mes 13
        this.totalDebitoAntesImpostosMes13 = this.demonstracaoResultados.somaContaDebit71mes13 + this.demonstracaoResultados.somaContaDebit72mes13 +  this.demonstracaoResultados.somaContaDebit75mes13 + this.demonstracaoResultados.somaContaDebit61mes13 + this.demonstracaoResultados.somaContaDebit62mes13 + this.demonstracaoResultados.somaContaDebit63mes13 + this.demonstracaoResultados.somaContaDebit78mes13 + this.demonstracaoResultados.somaContaDebit68mes13
        // Total mes 13
        this.totalAntesImpostosMes13 = this.totalCreditoAntesImpostosMes13 - this.totalDebitoAntesImpostosMes13

        // Credito mes 14
        this.totalCreditoAntesImpostosMes14 = this.demonstracaoResultados.somaContaCredit71mes14 + this.demonstracaoResultados.somaContaCredit72mes14 +  this.demonstracaoResultados.somaContaCredit75mes14 + this.demonstracaoResultados.somaContaCredit61mes14 + this.demonstracaoResultados.somaContaCredit62mes14 + this.demonstracaoResultados.somaContaCredit63mes14 + this.demonstracaoResultados.somaContaCredit78mes14 + this.demonstracaoResultados.somaContaCredit68mes14
        // Debito mes 14
        this.totalDebitoAntesImpostosMes14 = this.demonstracaoResultados.somaContaDebit71mes14 + this.demonstracaoResultados.somaContaDebit72mes14 +  this.demonstracaoResultados.somaContaDebit75mes14 + this.demonstracaoResultados.somaContaDebit61mes14 + this.demonstracaoResultados.somaContaDebit62mes14 + this.demonstracaoResultados.somaContaDebit63mes14 + this.demonstracaoResultados.somaContaDebit78mes14 + this.demonstracaoResultados.somaContaDebit68mes14
        // Total mes 14
        this.totalAntesImpostosMes14 = this.totalCreditoAntesImpostosMes14 - this.totalDebitoAntesImpostosMes14

        // Credito mes 20
        this.totalCreditoAntesImpostosMes20 = this.demonstracaoResultados.somaContaCredit71mes20 + this.demonstracaoResultados.somaContaCredit72mes20 +  this.demonstracaoResultados.somaContaCredit75mes20 + this.demonstracaoResultados.somaContaCredit61mes20 + this.demonstracaoResultados.somaContaCredit62mes20 + this.demonstracaoResultados.somaContaCredit63mes20 + this.demonstracaoResultados.somaContaCredit78mes20 + this.demonstracaoResultados.somaContaCredit68mes20
        // Debito mes 20
        this.totalDebitoAntesImpostosMes20 = this.demonstracaoResultados.somaContaDebit71mes20 + this.demonstracaoResultados.somaContaDebit72mes20 +  this.demonstracaoResultados.somaContaDebit75mes20 + this.demonstracaoResultados.somaContaDebit61mes20 + this.demonstracaoResultados.somaContaDebit62mes20 + this.demonstracaoResultados.somaContaDebit63mes20 + this.demonstracaoResultados.somaContaDebit78mes20 + this.demonstracaoResultados.somaContaDebit68mes20
        // Total mes 20
        ...
        console.log("resultado antes "+ this.totalResultadoLiquidoSemImpostos)
         // PRIMEIRA PARTE
          this.primeiraParte[0].value = this.round(((this.demonstracaoResultados.somaContaCredit71mes12 + this.demonstracaoResultados.somaContaCredit72mes12 + this.demonstracaoResultados.somaContaCredit71mes13 + this.demonstracaoResultados.somaContaCredit72mes13) - (this.demonstracaoResultados.somaContaDebit71mes12 + this.demonstracaoResultados.somaContaDebit72mes12 + this.demonstracaoResultados.somaContaDebit71mes13 + this.demonstracaoResultados.somaContaDebit72mes13) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[1].value = this.round(((this.demonstracaoResultados.somaContaCredit75mes12+ this.demonstracaoResultados.somaContaCredit71mes13)-(this.demonstracaoResultados.somaContaDebit75mes12+ this.demonstracaoResultados.somaContaDebit75mes13)),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[2].value = this.round(((this.demonstracaoResultados.somaContaCredit61mes12  + this.demonstracaoResultados.somaContaCredit61mes13 ) - (this.demonstracaoResultados.somaContaDebit61mes12 + this.demonstracaoResultados.somaContaDebit61mes13 ) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[3].value = this.round(((this.demonstracaoResultados.somaContaCredit62mes12  + this.demonstracaoResultados.somaContaCredit62mes13) - ( this.demonstracaoResultados.somaContaDebit62mes12 +  this.demonstracaoResultados.somaContaDebit62mes13) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[4].value = this.round(((this.demonstracaoResultados.somaContaCredit63mes12+ this.demonstracaoResultados.somaContaCredit63mes13) - (this.demonstracaoResultados.somaContaDebit63mes12+ this.demonstracaoResultados.somaContaDebit63mes13)),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[5].value = this.round(((this.demonstracaoResultados.somaContaCredit78mes12  + this.demonstracaoResultados.somaContaCredit78mes13 ) - (this.demonstracaoResultados.somaContaDebit78mes12  + this.demonstracaoResultados.somaContaDebit78mes13 ) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.primeiraParte[6].value = this.round(((this.demonstracaoResultados.somaContaCredit68mes12  + this.demonstracaoResultados.somaContaCredit68mes13 ) - (this.demonstracaoResultados.somaContaDebit68mes12  + this.demonstracaoResultados.somaContaDebit68mes13 ) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          ...
          // SEGUNDA PARTE
          this.segundaParte[0].value = this.round(((this.demonstracaoResultados.somaContaCredit64mes12  + this.demonstracaoResultados.somaContaCredit64mes13) - (this.demonstracaoResultados.somaContaDebit64mes12 + this.demonstracaoResultados.somaContaDebit64mes13) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.segundaParte[1].value = this.round(this.totalResultadoOperacional,2).toLocaleString('de-DE', {maximumFractionDigits:2})
          // TERCEIRA PARTE
          this.terceiraParte[0].value = this.round(((this.demonstracaoResultados.somaContaCredit79mes12  + this.demonstracaoResultados.somaContaCredit79mes13) - (this.demonstracaoResultados.somaContaDebit79mes12  + this.demonstracaoResultados.somaContaDebit79mes13) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
          this.terceiraParte[1].value = this.round(((this.demonstracaoResultados.somaContaCredit69mes12  + this.demonstracaoResultados.somaContaCredit69mes13) - (this.demonstracaoResultados.somaContaDebit69mes12 + this.demonstracaoResultados.somaContaDebit69mes13) ),2).toLocaleString('de-DE', {maximumFractionDigits:2})
